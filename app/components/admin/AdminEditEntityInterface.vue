...
<template>
  ...
  >
    <!-- 
      TypeScript cannot strongly type v-model for generic dynamic components (<component :is="...">),
      so 'as any' is necessary here. Strict typing is enforced inside each form component.
    -->
    <component
      :is="getAdminEditEntityFormComponent(entityName)"
      v-model="editableEntity as any"
    />
