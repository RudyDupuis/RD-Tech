<template>
  <footer
    class="flex flex-col sm:flex-row space-y-5 sm:space-y-0 items-center justify-between bg-dark-primary px-0 sm:px-20 py-10 mt-10"
  >
    ...
    <p class="text-light text-sm">
      Copyright © {{ new Date().getFullYear() }} Rudy Dupuis
    </p>
  </footer>
</template>
